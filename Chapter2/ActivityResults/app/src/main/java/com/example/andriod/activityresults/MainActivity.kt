...
const val PICK_RAINBOW_COLOR_REQUEST_CODE =1
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.submi_button).setOnClickListener {
            Intent(this,RainbowColorActivity::class.java).also {
                it ->
                startActivityForResult(it, PICK_RAINBOW_COLOR_REQUEST_CODE)
            }
        }
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == PICK_RAINBOW_COLOR_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            ...
            val rainbowColor = findViewById<TextView>(R.id.rainbow_color_tv)
